...
namespace Nxr.Internal
{
    ...
    public class HoloeverSystemUITeleport : MonoBehaviour, INxrGazeResponder
    {
        public void OnGazeEnter()
        {
            Debug.Log("HoloeverSystemUITeleport.OnGazeEnter");
        }

        public void OnGazeExit()
        {
            Debug.Log("HoloeverSystemUITeleport.OnGazeExit");
        ...
        {
            Debug.Log("HoloeverSystemUITeleport.OnGazeTrigger");
