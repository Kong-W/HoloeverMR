...
{
    public class HoloeverRemindBoxBase : MonoBehaviour
    {
        ...
        public void Create(string name, Vector3 position, Vector2 size, HoloeverRemindBoxEvent.RemindBoxEvent action)
        {
            GameObject quad =
            ...
            quad.GetComponent<HoloeverRemindBoxEvent>().handleRemindBox = action;
