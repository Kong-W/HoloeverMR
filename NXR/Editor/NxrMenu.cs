...
namespace Nxr.Internal
{
    public class NxrMenu
    {
        ...
        [MenuItem("HoloeverXR/About Holoever XR", false, 200)]
        private static void OpenAbout()
        {
            EditorUtility.DisplayDialog("Holoever XR SDK for Unity",
        ...
        [MenuItem("HoloeverXR/APK Encryption", false, 199)]
        ...
        [MenuItem("HoloeverXR/SDK Verify", false, 199)]
