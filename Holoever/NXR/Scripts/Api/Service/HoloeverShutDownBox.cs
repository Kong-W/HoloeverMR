...
public class HoloeverShutDownBox : MonoBehaviour
{
    public static HoloeverShutDownBox Instance;
    ...
    void HandleShutDownBox(GameObject meshGo, HoloeverShutDownBoxEvent.ShutDownBoxEvent action)
    {
        var holoeverShutDownBoxEvent = meshGo.GetComponent<HoloeverShutDownBoxEvent>();
        holoeverShutDownBoxEvent.handleShutDownBox = action;
    }
