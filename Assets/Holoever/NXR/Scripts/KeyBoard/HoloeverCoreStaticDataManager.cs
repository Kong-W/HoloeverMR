...
namespace Nxr.Internal
{
    ...
    public class HoloeverCoreStaticDataManager
    {
        private static HoloeverCoreStaticDataManager m_instance = null;
        public static HoloeverCoreStaticDataManager instance
        {
            get
            {
                if (m_instance == null)
                    m_instance = new HoloeverCoreStaticDataManager();
                return m_instance;
            }
        }
        ...
        public HoloeverCoreStaticDataManager()
        {
