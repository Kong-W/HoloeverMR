...
namespace Nxr.Internal
{
    ...
    /// 
    /// </summary>
    public class HoloeverMarker : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                float[] leftEyeArray = HoloeverService.GetMarkerViewMatrix(0);
                float[] rightEyeArray = HoloeverService.GetMarkerViewMatrix(1);
                ...
                float[] array = HoloeverService.GetMarkerViewMatrix();
                if (array != null)
                {
                    if (!visible)
                    {
        ...
        {
            // change scene
            if (AutoStartMarkerRecognize && HoloeverService != null && HoloeverService.IsMarkerRecognizeRunning)
            {
                HoloeverService.StopMarkerRecognize();
            }
        }
