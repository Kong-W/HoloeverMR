...
namespace Nxr.Internal
{
    ...
    public class HoloeverService
    {
        ...
        public void Init()
        {
            ...
            holoeverSensorServiceObject = holoeverSDKClass.CallStatic<AndroidJavaObject>("getNibiruSensorService", androidActivity);
            holoeverVoiceServiceObject = holoeverSDKClass.CallStatic<AndroidJavaObject>("getNibiruVoiceService", androidActivity);
            holoeverGestureServiceObject = holoeverSDKClass.CallStatic<AndroidJavaObject>("getNibiruGestureService", androidActivity);
            holoeverVRServiceObject = holoeverSDKClass.CallStatic<AndroidJavaObject>("getUsingNibiruVRServiceGL");

            holoeverCameraServiceObject = holoeverSDKClass.CallStatic<AndroidJavaObject>("getNibiruCameraService", androidActivity);
            holoeverMarkerServiceObject = holoeverSDKClass.CallStatic<AndroidJavaObject>("getNibiruMarkerService", androidActivity);
        ...
        public void RegHandleNKey(int mode)
        {
            if (holoeverVRServiceObject != null)
            {
                ...
                {
                    holoeverVRServiceObject.Call("regHandleNKey", mode);
                }));
            }
            else
            {
        ...
        public void RegisterVirtualMouseService(OnVirtualMouseServiceStatus serviceStatus)
        {
            ...
            {
                holoeverOsServiceObject.Call("registerVirtualMouseManagerService", new HoloeverVirtualMouseServiceListener(serviceStatus));
            }
            else
            {
                Debug.LogError("RegisterVirtualMouseService failed, holoeverVRServiceObject is null !!!");
            }
        }
        ...
        public void UnRegisterVirtualMouseService()
        {
            ...
            {
                Debug.LogError("UnRegisterVirtualMouseService failed, holoeverVRServiceObject is null !!!");
            }
        }
        ...
        public bool SetEnableVirtualMouse(bool enabled)
        {
            ...
            {
                Debug.LogError("SetEnableVirtualMouse failed, holoeverVRServiceObject is null !!!");
                return false;
            }
        }
        ...
        public void GetCameraStatus()
        {
            ...
            {
                Debug.LogError("GetCameraStatus failed, because holoeverVRServiceObject is null !!!");
            }
        }
        ...
        private AndroidJavaObject OpenCamera(int cameraId= (int)CAMERA_ID.FRONT)
        {
            //int cameraId = HMDCameraId;
            //cameraId = ControllerCameraId;// add id=1;
            //int count = holoeverCameraServiceObject.Call<int>("getCameraNum");
            //cameraId = count - 1;
        ...
        {
            public HoloeverSensorDataListenerCallback() : base("com.nibiru.service.NibiruSensorService$INibiruSensorDataListener")
            { }
        ...
        public void RegisterSensorListener(SENSOR_TYPE type, SENSOR_LOCATION location)
        {
            if (holoeverSensorServiceObject != null)
            {
                ...
                RunOnUIThread(androidActivity, new AndroidJavaRunnable(() =>
                {
                    ...
                    holoeverSensorServiceObject.Call<bool>("registerSensorListener", typeObj, locationObj, holoeverSensorDataListenerCallback);
        ...
        {
            IsCaptureEnabled = 1;
            holoeverSDKClass.CallStatic("startCaptureForUnity", new CaptureCallback(), path, bitRate, seconds, videoSize, HMDCameraId);
        }
        ...
        public class HoloeverVirtualMouseServiceListener : AndroidJavaProxy
        {
            ...
            public HoloeverVirtualMouseServiceListener(OnVirtualMouseServiceStatus onVirtualMouseServiceStatus) : base("com.nibiru.service.NibiruVirtualMouseManager$VirtualMouseServiceListener")
            {
