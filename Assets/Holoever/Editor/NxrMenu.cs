...
namespace Nxr.Internal
{
    public class NxrMenu
    {
        ...
        [MenuItem("HoloeverMR/About Holoever MR", false, 200)]
        private static void OpenAbout()
        {
            EditorUtility.DisplayDialog("Holoever MR SDK for Unity",
                "Version: " + NxrViewer.NXR_SDK_VERSION + "\n\n"
                + "Copyright: ©2021 Holoever Inc. All rights reserved.\n",
                "OK");
        }
        ...
        [MenuItem("HoloeverMR/APK Encryption", false, 199)]
        public static void createApkEncryptionMenu()
        {
            NxrApkEncryptionEditor window = (NxrApkEncryptionEditor)EditorWindow.GetWindow(typeof(NxrApkEncryptionEditor), false, "Holoever Apk Encryption");
            window.minSize = new Vector2(300, 60);
            window.Show();
        }

        [MenuItem("HoloeverMR/SDK Verify", false, 199)]
        public static void createSDKVerifyMenu()
        {
            NxrSDKVerifyEditor window = (NxrSDKVerifyEditor)EditorWindow.GetWindow(typeof(NxrSDKVerifyEditor), false, "Holoever SDK Verify");
            window.minSize = new Vector2(300, 60);
            window.Show();
        }
